...
def run_test_factorial():
    ...
    # Test 3:
    answer_from_oracle = math.factorial(78)
    answer_from_my_code = factorial(78)
...
def run_test_count_cosines_from():
    ...
    # Test 2
    expected = 0
    answer = count_cosines_from(1, 90000, 2)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3
    expected = 1
    answer = count_cosines_from(0, 10, 0.999)
    ...
    # Test 6
    expected = 2
    answer = count_cosines_from(6, 9, 0.7)
